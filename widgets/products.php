...
/**
 * LB Elementor Product Image Hover Effects
 * 
 * @package lbelementor
 */
...
class products extends Widget_Base
{
  ...
  {
    return 'lb-products-hoverimage';
  }

  public function get_title()
  {
    return __('LB Products Image');
  }
...
?>
      ...
      <div class="d-md-none d-lbsm-block">
        <div class="swiper lb-product-swiper">
          <div class="lb-smproduct-slider swiper-wrapper">
            <?php
            while ($post_query->have_posts()) :
              $post_query->the_post();
              $secimage = get_field('lbsecondfeatured');
            ...
            ?>
              ...
              <div class="swiper-slide">
                ...
                <div class="lb-elementor-buybutton mt-25">
                  <button type="button" class="lbmodalbtn">
                    <span><?php echo __('Buy', 'lbelementor'); ?></span>
                    <span class="lbbtn-icon">
                      <svg width="498" height="625" viewBox="0 0 498 625" fill="none" xmlns="http://www.w3.org/2000/svg">
